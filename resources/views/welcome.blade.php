...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{ asset('templates/vendor/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('templates/vendor/devicons/css/devicons.min.css') }}" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <div class="subheading mb-5">Daan Mogot Baru, Bedugul Street Block 1A 14 Kalideres West Jakarta 11840, Jakarta, Indonesia· (+62) 87825913730 ·
            <a href="mailto:jody.almaida@gmailcom">medivh13@jodyalmaida.com / jody.almaida@gmail.com</a>
          </div>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
        <div class="my-auto">
          ...
          <ul class="list-inline list-icons">
            ...
            <li class="list-inline-item">
              <i class="devicons devicons-cisco"></i>
            </li>
            <li class="list-inline-item">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
        <div class="my-auto">
          ...
          <p>Apart from being a web developer, I enjoy most of my time being together with my family, reading, and writting.</p>
    ...
    <script src="{{ asset('templates/js/resume.min.js') }}"></script>
